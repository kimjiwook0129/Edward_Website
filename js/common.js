...
$chi = $(button)
  ...
  .attr("data-target", "#myNavbar")
  .attr("id", "collapse-navbar-button");
$par.append($chi);
$par = $chi;
...
$par.append(
  $(li).append(
    $(a)
      .text("Working Background")
      .attr("href", "about-working.html?lang=eng")
      .attr("id", "working-button")
  )
);
$par.append(
  $(li).append(
    $(a)
      .text("Traveling Background")
      .attr("href", "about-traveling.html?lang=eng")
      .attr("id", "traveling-button")
  )
);
$par.append(
  $(li).append(
    $(a)
      ...
      .attr("href", "about-studying.html?lang=eng")
      .attr("id", "studying-button")
  )
);
...
$chi.append(
  $(a)
    .text("Co-op Résumé")
    .attr("href", "documents/résumé/fulltime.pdf")
    .attr("target", "_blank")
    .attr("id", "coop-button")
);
...
$chi = $(li).append(
  $(a)
    .text("Projects")
    .attr("href", "projects.html?lang=eng")
    .attr("id", "projects-button")
);
$par.append($chi);
...
$chi = $(p)
  .text("Copyright © 2019 Jiwook Kim")
  .addClass("copyright");
$par.append($chi);
...
mediaLink(
  $par,
  "youtube",
  "https://www.youtube.com/channel/UCRbFENcMzbCHXQEdVBYKfFA?view_as=subscriber"
);
...
$("#reference_total").text(
  "* All image/icons have been used under each copyright owner's Terms of Service and permitted to be used."
);
